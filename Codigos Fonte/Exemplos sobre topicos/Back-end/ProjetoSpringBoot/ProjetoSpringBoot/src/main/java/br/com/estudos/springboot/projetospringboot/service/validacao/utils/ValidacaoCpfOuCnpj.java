package br.com.estudos.springboot.projetospringboot.service.validacao.utils;
...
public class ValidacaoCpfOuCnpj {
    ...
    public static boolean isNotValidCpf(String ssn){
        return !isValidCpf(ssn);
    }

    public static boolean isNotValidCnpj(String tfn){
        return !isValidCnpj(tfn);
    }
}
