...
public class ImageService {
    ...
    public BufferedImage cropSquare(BufferedImage sourceImg){
        int smallerSide = (sourceImg.getHeight() <=  sourceImg.getWidth()) ? sourceImg.getHeight() : sourceImg.getWidth();

        return Scalr.crop(
            sourceImg,
            (sourceImg.getWidth() - smallerSide)/2,
            (sourceImg.getHeight() - smallerSide)/2,
            smallerSide,
            smallerSide);
    }
